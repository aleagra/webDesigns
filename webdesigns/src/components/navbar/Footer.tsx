...
export const Footer: React.FC = () => {
	return (
		<div className="flex xl:items-end 2xl: flex-wrap max-xl:flex-col text-sm uppercase mt-10 xl:mb-6 2xl:mb-0 lg:justify-between text-white font-light select-none">
