...
const ProjectsCards: React.FC<ProjectCardProps> = ({ img, title, name }) => {
	return (
		<>
			<section className="rounded-lg border-4 shadow-lg border-white relative h-[370px] grid grid-rows-[280px_1fr] hover:text-white hover:bg-[#162a21] hover:border-[#162a21] transition duration-500 ease-out bg-white hover:-translate-y-3">
