...
export const Cards: React.FC<CardsProps> = ({ index, title, setModal, name }) => {
	return (
		<div
			...
			className="grid xl:grid-cols-3 grid-cols-2 w-full 2xl:py-8 py-12 2xl:px-16 px-8 cursor-pointer items-center border-b group button first:border-t border-white/20 text-white transition-all duration-200 project font-medium"
		>
