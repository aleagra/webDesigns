	...
	return (
		<>
			<motion.div
				...
				className="2xl:h-[200px] 2xl:w-[250px] xl:h-[130px] xl:w-[200px] w-[180px] h-[150px] absolute bg-white overflow-hidden pointer-events-none flex items-center justify-center"
			>
